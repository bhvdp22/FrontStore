...
<body>
    <div class="container">
        ...
        <ol class="steps">
            ...
            <li><strong>Track Orders and Payments</strong> - Manage orders, process returns, and request payouts from your dashboard.</li>
            <li><strong>Build Your Reputation</strong> - Deliver quality products on time to earn strong customer reviews.</li>
        </ol>
