        ...
        @endif
            ...
            <div class="dashboard-grid">
                ...
                <div class="card">
                    ...
                    @php
                        $repData = $seller ? \Illuminate\Support\Facades\Cache::remember('rep_' . $seller->id, 300, function() use ($seller) {
                            return app(\App\Services\SellerReputationService::class)->calculate($seller->id);
                        }) : ['score' => 0, 'badge' => 'New', 'breakdown' => ['on_time_delivery' => 0, 'return_rate' => 0, 'customer_rating' => 0]];
